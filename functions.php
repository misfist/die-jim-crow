...
function die_jim_crow_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'die_jim_crow_content_width', 640 );
}
...
function die_jim_crow_scripts() {
	...
	wp_enqueue_script( 'die-jim-crow-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'die-jim-crow-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
