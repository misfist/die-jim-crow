...
module.exports = {
	...
	// Project options.
	projectURL: 'diejimcrow.test', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// Translation options.
	textDomain: 'die-jim-crow', // Your textdomain here.
	translationFile: 'djc.pot', // Name of the translation file.
	translationDestination: './languages', // Where to save the translation files.
	packageName: 'Die_Jim_Crow', // Package name.
